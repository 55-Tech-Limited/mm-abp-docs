...
description: "55 Tech Scraping API — 通过 80 多个地理分布式代理节点路由 HTTP、WebSocket 和 AMQP 请求。"
---

## 什么是 Scraping API？

**Scraping API** 由 [55 Tech](https://55-tech.com/) 提供，可将您的 HTTP、WebSocket 和 AMQP 请求通过由 80 多个地理分布式代理节点组成的网络进行路由。API 会在数秒内自动识别每个目标最可靠的代理节点，让您的请求立即变得更加成功，无需自行管理代理。
