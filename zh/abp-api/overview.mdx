...
sidebarTitle: "概述"
description: "ABP v2 API 概述。通过单一统一API在30家博彩公司进行投注，具备智能路由、部分成交、实时跟踪和自动结算功能。"
---

## 什么是 ABP？

**自动投注（ABP）** API 由 [55 Tech](https://55-tech.com/) 提供，让您通过单一集成在30家博彩公司进行投注。无需构建和维护各个博彩公司的连接器，ABP 处理从投注到结算的全部生命周期。
...
博彩公司通过标识字符串识别（例如 `pinnacle`、`betfair-ex`、`polymarket`）。使用 `GET /bookmakers` 列出所有30家支持的博彩公司及其默认投注限额。
...
**传统体育博彩：** pinnacle, pinnacleb2b, betamapola, betcris, bookmaker.eu, cloudbet, cloudbetb2b, justbet, kaiyun, monkeyline.vip, novig.us, 198bet, paradisewager, sharpbet, singbet, sports411.ag, 3et, vertex

**博彩交易所：** betfair-ex, limitless-ex, matchbook, smarkets

**预测市场：** 4casters, kalshi, polymarket, polymarket.us, predict.fun, prophetx, sx.bet
