...
description: "55 Tech Scraping API — route HTTP, WebSocket, and AMQP requests through 80+ geo-distributed agents."
---

## What is the Scraping API?

The **Scraping API** by [55 Tech](https://55-tech.com/) lets you route HTTP, WebSocket, and AMQP requests through a network of 80+ geo-distributed agents. Within seconds, the API automatically identifies the most reliable agents for each target — so your requests become instantly more successful without managing proxies yourself.
